...
import StudentNotificationsModal from './StudentNotificationsModal.tsx';
import AdministrativeMessages from './AdministrativeMessages.tsx';
import TeacherMessages from './TeacherMessages.tsx';
import StudentScheduleView from './StudentScheduleView.tsx';
import StudentMonthlyResults from './StudentMonthlyResults.tsx';
import StudentBehaviorView from './StudentBehaviorView.tsx';
import XoLeaderboard from './XoLeaderboard.tsx';
import XoChallenges from './XoChallenges.tsx';
import HonorBoardView from '../shared/HonorBoardView.tsx';
import MyHomework from './MyHomework.tsx';
import HallOfFame from '../shared/HallOfFame.tsx';
import MyProgress from './MyProgress.tsx';
import HomeworkSubmissionView from './HomeworkSubmissionView.tsx';
import EducationalEncyclopedia from './EducationalEncyclopedia.tsx';
...
export default function StudentApp({ currentUser, onLogout }: StudentAppProps) {
    ...
    const handleOpenNotifications = () => {
        ...
        if (unreadIds.length > 0) {
            ...
            // FIX: Using currentUser.principalId because principalId was not defined in this scope.
